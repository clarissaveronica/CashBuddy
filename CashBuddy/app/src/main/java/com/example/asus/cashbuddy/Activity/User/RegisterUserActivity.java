...
public class RegisterUserActivity extends AppCompatActivity implements RegistrationCancellationDialogFragment.CancellationHandler{
        ...
        submitButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if(validateForm()) {
                    ...
                    Intent intent = new Intent(RegisterUserActivity.this, NumberVerificationActivity.class);
