...
public class RegisterMerchantActivity extends AppCompatActivity implements RegistrationCancellationDialogFragment.CancellationHandler{
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                if(validateForm()) {
                    ...
                    Intent intent = new Intent(RegisterMerchantActivity.this, NumberVerificationActivity.class);
