...
import com.example.asus.cashbuddy.Fragment.User.PhoneTransferFragment;
...
public class TransferActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(TransferActivity.this, R.array.methods, android.R.layout.simple_spinner_item);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(choose.equals("Scan QR")){
                    ...
                    content.setVisibility(View.VISIBLE);
                    manager.beginTransaction().replace(R.id.content, new PhoneTransferFragment()).commit();
